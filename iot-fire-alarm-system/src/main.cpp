...
const char* ssid = "NANDU";  
const char* password = "Jaideep15";  
...
byte sendEmail()
{
  ...
  Client.println("amFpZGVlcC50cmlwdXJhbmkuMTljc2VAYm11LmVkdS5pbg=="); //base64, ASCII encoded SMTP Username   
  if (!emailResp()) 
    return 0;

  Serial.println(F("Sending Password"));
  Client.println("SkFJZGVlcEAxMjM=");   //base64, ASCII encoded SMTP Password    
  if (!emailResp()) 
    return 0;
